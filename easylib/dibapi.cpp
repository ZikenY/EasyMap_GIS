...
void GetDIBSize(const HDIB hDIB, long& width, long& height)
{
	LPBYTE lpDIB = (LPBYTE)GlobalLock(hDIB);
...
{ 
	...
	int nDeviceBitsPixel = GetDeviceCaps((HDC)hDC, BITSPIXEL);
...
BOOL PaintDIBOops(void* hDC, LPRECT lpDCRect, void* hDIB, LPRECT lpDIBRect,
        void* hPal, DWORD dwRop)
{
    return PaintDIB((HDC)hDC, lpDCRect, (HDIB)hDIB, lpDIBRect, (HPALETTE)hPal, dwRop);
};
