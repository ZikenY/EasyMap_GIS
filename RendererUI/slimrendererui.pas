...
function SelectRenderer(pVLA: IVectorLayerAgent): Boolean; stdcall;
...
type
  TFormRendererUI = class(TForm)
    ...
    GroupBox4: TGroupBox;
    CBColorGrade: TComboBox;
    GroupBox5: TGroupBox;
    CBGradeLevel: TComboBox;
    GroupBox6: TGroupBox;
    Button7: TButton;
    GroupBox7: TGroupBox;
    Label1: TLabel;
    ...
    Edit1: TEdit;
    Edit2: TEdit;
    CBGradeColor: TCheckBox;
    CBGradeSize: TCheckBox;
    ...
    procedure CBColorUVClick(Sender: TObject);
  private
...
function SelectRenderer(pVLA: IVectorLayerAgent): Boolean;
var
    FormRendererUI: TFormRendererUI;
begin
    Result := False;
    ...
    FormRendererUI := TFormRendererUI.Create(nil);
    FormRendererUI.m_pVLA := pVLA;
    FormRendererUI.ShowModal();
    Result := FormRendererUI.m_OK;
    FormRendererUI.Free();
end;
...
begin
    ...
    if (CBColorGrade.ItemIndex < 0) then begin
        CBColorGrade.ItemIndex := 0;
    end;
    CBGradeLevel.Clear();
    for i := 1 to 40 do begin
        CBGradeLevel.Items.Add(IntToStr(i));
    end;
    CBGradeLevel.ItemIndex := 0;
...
procedure TFormRendererUI.CBColorUVClick(Sender: TObject);
var
    i, count: Longint;
    key: IAnsiString;
    pObj: IObj;
