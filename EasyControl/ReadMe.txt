========================================================================
		ActiveX Control DLL : EASYCONTROL
========================================================================

ControlWizard has created this project for your EASYCONTROL ActiveX Control
...
that make up your EASYCONTROL ActiveX Control DLL.
...
EasyControlCtl.h
	This file contains the declaration of the CEasyControlCtrl C++ class.

EasyControlCtl.cpp
	This file contains the implementation of the CEasyControlCtrl C++ class.

EasyControlPpg.h
	This file contains the declaration of the CEasyControlPropPage C++ class.

EasyControlPpg.cpp
	This file contains the implementation of the CEasyControlPropPage C++ class.

EasyControlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CEasyControlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file EasyControl.rc.
